...
<html lang="sv">
  <head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Karla:400,700|Wellfleet' rel='stylesheet' type='text/css'>
	    ...
	    <div class="container">
			<div class="header">
			        <ul class="nav nav-pills pull-right">
			             <li><a href="logout.php" class="btn" id="logout">Logga ut</a></li>
			        </ul>
